        ...
        <div class="relative z-10 flex flex-col justify-between p-12 w-full">
          ...
          <div class="max-w-md">
            <h1 class="text-4xl font-display font-bold text-white leading-tight mb-6">
              Join the future of HR Verification.
            </h1>
            <p class="text-lg text-primary-200 leading-relaxed mb-8">
              Create an account to streamline background checks, manage verification records, and maintain compliance — all from one platform.
            </p>
        ...
        <div class="w-full max-w-[400px]">
          ...
          <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-text-secondary">
              Already have an account? <a routerLink="/login" class="text-primary-600 font-medium hover:text-primary-700">Sign in</a>
            </p>
          </div>
          ...
          <form [formGroup]="signupForm" (ngSubmit)="onSubmit()" class="space-y-5">
            ...
            <div>
              ...
              <input id="name" formControlName="name" type="text" autocomplete="name"
                     class="input" placeholder="Enter your full name">
            </div>
            ...
            <div>
              ...
              <input id="password" formControlName="password" type="password" autocomplete="new-password"
                     class="input" placeholder="Create a password">
            </div>

            <!-- Submit -->
            <button type="submit" [disabled]="signupForm.invalid || isLoading"
                    class="btn-primary w-full py-2.5 mt-4" id="signup-submit-btn">
